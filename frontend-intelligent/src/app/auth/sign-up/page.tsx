            ...
            <div className="custom-gradient-1 h-full rounded-l-[10px] p-8 sm:p-12.5 dark:!bg-dark-2 dark:bg-none">
              ...
              <div className="mb-6">
                ...
                <p className="mb-8 text-base font-medium text-dark-4 dark:text-dark-6">
                  Tu rostro será registrado de forma segura para futuros inicios de sesión.
                  Mira a la cámara cuando completes el formulario.
                </p>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-dark-4 dark:text-dark-6">
                        Inicia sesión en segundos sin recordar contraseñas
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl bg-white/50 p-4 backdrop-blur-sm dark:bg-dark/30">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-dark-4 dark:text-dark-6">
                        Protección biométrica de última generación
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full p-8 sm:p-12.5">
              <div className="mb-8">
                ...
                <p className="text-sm text-dark-4 dark:text-dark-6">
                  Completa tus datos y mira a la cámara para registrarte
                </p>
              </div>
